...
2. **Run the setup script**:
   ...
   #Download the powershell from this repository
   ...
   #Remove the script from your PC
   rm "$env:TEMP\script.ps1"
   ```

   _Note: The script will install and configure Oh My Posh and PSReadLine automatically._
